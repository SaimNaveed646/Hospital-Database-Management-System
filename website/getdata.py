...
app.config['SQLALCHEMY_DATABASE_URI'] = 'oracle+cx_oracle://C##scott:tiger@localhost:1521/xe'
...
# Route to put/change appointment status
...
# Route for searching doctor for doctor page
